# Hart Platform Javascript Style Guide
...
## Whitespace
  ...
  - [18.3](#18.3) <a name='18.3'></a> Place 1 space before the opening parenthesis in control statements (`if`, `while` etc.). As well as a space before the argument list in function calls and declarations.
